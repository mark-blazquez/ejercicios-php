			...
			<div>
				...
				<form action="{{route("administrador")}}" method="post">
					...
					<div class="form-group d-none">
						...
						<input class="form-control" type="number" name="id" value="{{request("id")}}" placeholder="id del producto">
					...
					<div class="form-group">
						...
						<input class="form-control" type="text" name="imagen" value="{{old("imagen")}}" placeholder="imagen">
